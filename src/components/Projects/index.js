  ...
  return (
    <Container id="projects">
      <Wrapper>
        ...
        <Desc>
        J'ai travaillé sur un large éventail de projets.Voici quelques-uns d'eux.
        </Desc>
        <ToggleButtonGroup >
          {toggle === 'all' ?
          ...
          {toggle === 'machine learning' ?
            <ToggleButton active value="machine learning" onClick={() => setToggle('machine learning')}>INTELLIGENCE ARTIFICIELLE</ToggleButton>
            :
            <ToggleButton value="machine learning" onClick={() => setToggle('machine learning')}>INTELLIGENCE ARTIFICIELLE</ToggleButton>
          }
        </ToggleButtonGroup>
        <CardContainer>
          {toggle === 'all' && projects
